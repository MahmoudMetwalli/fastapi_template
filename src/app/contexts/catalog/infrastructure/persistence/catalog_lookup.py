...
SQLAlchemy-backed implementation lives at the infrastructure edge and
explicitly subclasses it.
...
class SqlAlchemyCatalogLookup(SqlAlchemySessionScoped, CatalogLookup):
